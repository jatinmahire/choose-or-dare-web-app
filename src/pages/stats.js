// stats.js — placeholder until Phase 11
import { store }           from '../store.js';
import { mountBottomNav }  from './home.js';

export default function renderStats(params, router) {
  ...
  app.innerHTML = `
    <div style="min-height:100dvh;background:#0A0A0F;color:#e6e0ee;
      ...
      <h1 style="font-family:'Bricolage Grotesque',system-ui,sans-serif;
        font-size:24px;font-weight:800;color:#cdbdff;margin:0 0 8px">Your Stats</h1>
