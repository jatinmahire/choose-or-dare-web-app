...
var t = /* @__PURE__ */ __name(({ base: e = "", routes: t2 = [], ...o2 } = {}) => ({ __proto__: new Proxy({}, { get: /* @__PURE__ */ __name((o3, r2, a2, s2) => (o4, ...n2) => t2.push([r2.toUpperCase?.(), RegExp(`^${(s2 = (e + o4).replace(/\/+(\/|$)/g, "$1")).replace(/(\/?\.?):(\w+)\+/g, "($1(?<$2>*))").replace(/(\/?\.?):(\w+)/g, "($1(?<$2>[^$1/]+?))").replace(/\./g, "\\.").replace(/(\/?)\*/g, "($1.*)?")}/*$`), n2, s2]) && a2, "get") }), routes: t2, ...o2, async fetch(e2, ...r2) {
...
var n = /* @__PURE__ */ __name((e) => {
  e.proxy = new Proxy(e.proxy ?? e, { get: /* @__PURE__ */ __name((t2, o2) => t2[o2]?.bind?.(e) ?? t2[o2] ?? t2?.params?.[o2], "get") });
}, "n");
...
var y = /* @__PURE__ */ __name((e = {}) => {
  const { origin: t2 = "*", credentials: o2 = false, allowMethods: r2 = "*", allowHeaders: a2, exposeHeaders: s2, maxAge: n2 } = e, c2 = /* @__PURE__ */ __name((e2) => {
    ...
    for (const [o3, r3] of Object.entries(t3)) r3 && e2.headers.append(o3, r3);
    return e2;
  }, "l");
  return { corsify: /* @__PURE__ */ __name((e2, t3) => e2?.headers?.get("access-control-allow-origin") || 101 == e2.status ? e2 : l(new Response(e2.body, e2), { "access-control-allow-origin": c2(t3), "access-control-allow-credentials": o2 }), "corsify"), preflight: /* @__PURE__ */ __name((e2) => {
...
var session_default = /* @__PURE__ */ __name((request, env2, ctx) => r({ error: "Not implemented", route: "session" }, { status: 501 }), "default");

// src/routes/history.js
var history_default = /* @__PURE__ */ __name((request, env2, ctx) => r({ error: "Not implemented", route: "history" }, { status: 501 }), "default");

// src/routes/stats.js
var stats_default = /* @__PURE__ */ __name((request, env2, ctx) => r({ error: "Not implemented", route: "stats" }, { status: 501 }), "default");

// src/routes/leaderboard.js
var leaderboard_default = /* @__PURE__ */ __name((request, env2, ctx) => r({ error: "Not implemented", route: "leaderboard" }, { status: 501 }), "default");

// src/routes/cards.js
var cards_default = /* @__PURE__ */ __name((request, env2, ctx) => r({ error: "Not implemented", route: "cards" }, { status: 501 }), "default");

// src/routes/account.js
var account_default = /* @__PURE__ */ __name((request, env2, ctx) => r({ error: "Not implemented", route: "account" }, { status: 501 }), "default");
...
router.get("/health", () => r({ status: "ok" }));
router.all("/api/session/*", session_default);
router.all("/api/history/*", history_default);
router.all("/api/stats/*", stats_default);
router.all("/api/leaderboard/*", leaderboard_default);
router.all("/api/cards/*", cards_default);
router.all("/api/account/*", account_default);
router.all("*", () => r({ error: "Not Found" }, { status: 404 }));
...
// .wrangler/tmp/bundle-wbXMIF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-wbXMIF/middleware-loader.entry.ts
